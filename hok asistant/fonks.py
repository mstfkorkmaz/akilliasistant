from imported import (talkUS,myCommand,opn_gl, open_yt, open_dc,open_wp,open_tlg,open_cal,open_gedit,open_clden,open_atom,sy_hlo,sy_fine,sy_ty,
open_tw,wh_made,tk_nte,rd_nte,dl_nte,py_musc,py_stp,th_tme,th_dy,pc_kpt,pc_yndn,
pc_otrm,cl_brwsr,gl_mps,wk_pdia,gl_srch,gl_how,yt_srch,cpu_inf,hdd_inf,     
